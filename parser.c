...
void getOrderHex(char c1, char c2) { // dla danego rozkazu zwracamy jego kod zapisany w systemie dziesiętnym. Na system hexadecymalny zamieniamy go przy wypisywaniu
    if (c1 == 'A' && c2 == 'R') {
        tempRow.hex = 16;
        return;
    }
